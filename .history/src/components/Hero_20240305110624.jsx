...
const Hero = () => {
  ...
  <span className="letter-animation" style={{ animationDelay: "0.1s" }}>i</span>
  <span className="letter-animation" style={{ animationDelay: "0.2s" }}>t</span>
  <span className="letter-animation" style={{ animationDelay: "0.3s" }}>s</span>
  <span className="letter-animation" style={{ animationDelay: "0.4s" }}>i</span>
  <span className="letter-animation" style={{ animationDelay: "0.5s" }}> </span> {/* Space */}
  <span className="letter-animation" style={{ animationDelay: "0.6s" }}>K</span>
  <span className="letter-animation" style={{ animationDelay: "0.7s" }}>a</span>
  <span className="letter-animation" style={{ animationDelay: "0.8s" }}>g</span>
  <span className="letter-animation" style={{ animationDelay: "0.9s" }}>i</span>
  <span className="letter-animation" style={{ animationDelay: "1s" }}>s</span>
  <span className="letter-animation" style={{ animationDelay: "1.1s" }}>h</span>
  <span className="letter-animation" style={{ animationDelay: "1.2s" }}>o</span>
</span>
