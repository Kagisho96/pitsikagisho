...
const Testimonials = () => (
  <section
    id="experience"
    className={`${styles.paddingY} ${styles.flexCenter} flex relative`}
  >
    ...
    <div className="flex justify-between flex-col px-10 py-12 rounded-[20px]  max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
      ...
      <div className="">
        ...
        <p className="font-poppins font-normal text-[18px] leading-[32.4px] text-white my-10">
          I enjoy coding, chess, watching and playing soccer, reading, puzzles,
          fitness, DIY electronics, music, art, travel, cooking, and learning
          tech.
        </p>
      </div>
    </div>
