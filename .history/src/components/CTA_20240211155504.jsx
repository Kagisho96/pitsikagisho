...
const CTA = () => (
  ...
  <div className="">
    <div className="flex items-center justify-center">
      <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-gray-100">
        Get in touch
      </h2>
    </div>
    ...
    <div className="flex flex-col sm:flex-row w-full mt-4 justify-between">
      <div className="flex items-center mb-4 sm:mb-0">
        ...
        <p className="font-poppins font-semibold text-sm sm:text-base lg:text-lg text-gray-200 ml-3">
      ...
      <div className="flex items-center mb-4 sm:mb-0">
        ...
        <a className="font-poppins font-semibold text-sm sm:text-base lg:text-lg text-gray-200 ml-3" href="tel:+27721518903">
          +27 72 151 8903
        </a>
      </div>
